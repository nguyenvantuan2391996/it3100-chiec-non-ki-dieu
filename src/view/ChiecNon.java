...
public class ChiecNon extends JPanel {
	...
	public void paint(Graphics g) {
		...
		if (timequay-- > 0) {
			...
			int goc = gocXoay % 360;
			System.out.println("góc xoay được " + goc);
			if (goc <= 0 && goc > -18) {
				...
				// nếu không có thêm lượt chuyển lượt chơi
				if (ControllerClickButton.themluot == 0) {
					// mất lượt
			...
			if (ControllerGame.point != 0 && ControllerGame.point != 1 && ControllerGame.point != 2
					&& ControllerGame.point != 3 && ControllerGame.point != 5) {
